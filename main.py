...
string = getlyric()
Image.MAX_IMAGE_PIXELS = None; font = ImageFont.truetype("arial.ttf", 20); img = Image.new("RGB", tuple([dim.width, dim.height]), (255, 255, 255))
...
img.save(string + ".png"); print("File saved as " + string + ".png")